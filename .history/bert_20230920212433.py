...
class BertLayer(nn.Module):
    ...
    def forward(self, x, masked_attention):
        ...
        attention_output = self.do(self.attention_dense_layer(attention_output))
        attention_output = self.norm1(x+attention_output)
        ffoutput =self.do(self.ff(attention_output))
        out = self.norm2(ffoutput+attention_output)
        return out
class BertModel(BertPreTrainedModel):
    ...
    def embed(self, input_ids):
        ...
        out = self.do(self.embed_norm(out))
        return out
