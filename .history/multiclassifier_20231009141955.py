...
if __name__ == '__main__':
    ...
    config = SimpleNamespace(
        ...
        sst_dev_out = './multitask_prediction/'+args.option+'-sst-dev.csv',
        sst_test_out = './multitask_prediction/'+args.option+'-sst-test.csv',
        quora_training = './data/quora/quora-train.csv',
        quora_dev = './data/quora/quora-dev.csv',
        quora_test = './data/quora/quora-test-student.csv',
        quora_dev_out = './multitask_prediction/'+args.option+'-quora-dev.csv',
        quora_test_out = './multitask_prediction/'+args.option+'-quora-test.csv',
        sts_training = './data/sts/sts-train.csv',
        sts_dev = './data/sts/sts-dev.csv',
        sts_test = './data/sts/sts-test-student.csv',
        sts_dev_out = './multitask_prediction/'+args.option+'-sts-dev.csv',
        sts_test_out = './multitask_prediction/'+args.option+'-sts-test.csv',
